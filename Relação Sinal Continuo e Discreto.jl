...
# ╔═╡ ee273db5-6763-4e1a-a2ea-a50b01a4d2e0
begin
	using Plots
	using ControlSystems
end

# ╔═╡ 5013acb8-dddd-11ed-2ff1-4712e0f933e0
md"""
# Relação Sinal Continuo e Discreto
"""

# ╔═╡ c517bcdf-a43f-4835-8159-a3dcb95c004b
s = tf('s');

# ╔═╡ 25528dc5-0d84-4d28-a1a5-cae0bc2e3180
H = 1/5 / (s^2 + s/5 + 1/5)

# ╔═╡ 77279267-f483-4fb1-b5c0-70a7012eeaed
begin
	pic = plot(impulse(H))
	psc = plot(step(H))
	plot(pic, psc;
...
# ╔═╡ ff857084-e2c2-4d30-96e3-1707c38ce809
Hd = c2d(H,1,:zoh)

# ╔═╡ 3c5b8599-217d-4367-8e5d-548362077fa9
begin
	psd = plot(step(Hd))
	pid = plot(impulse(Hd))
	plot(pid,psd;
...
manifest_format = "2.0"
project_hash = "c5163bdef7f30617a12bf082d0c8d16834474b0d"
...
git-tree-sha1 = "9809050d8b28fbcd8a401525c91a1f9883b89e4a"
