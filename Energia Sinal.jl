...
# ╔═╡ 1d7d7a51-182f-405e-9e55-4db33bb33033
begin
	using Plots
	using DSP
end

# ╔═╡ a577aa3a-d264-11ed-14d3-43803f261358
md"""
# Energia Sinal
"""

# ╔═╡ 2d1948db-f301-4743-8802-498e1c96cc40
begin
	t = 0:1:20
	y = [4 <= i <= 16 ? 1 : 0  for i in 1:length(t)]
	x = y.*(sin.(2*pi*t/15).+1)
end;

# ╔═╡ 10a2716b-8b09-47e3-9971-21e455201daa
plot(t,x;
		line=:stem,
		marker=:circle,
		xlabel="Amostras",
...
# ╔═╡ bd88d279-5f61-4f80-b82b-be17dcae0811
energia=sum(abs.(x).^2)
