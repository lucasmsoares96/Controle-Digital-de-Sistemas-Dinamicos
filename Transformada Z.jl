...
# ╔═╡ e772e130-d73c-4a20-97f3-f57b1f57851d
begin
	using Plots
	using ControlSystemsBase
end

# ╔═╡ 6dee45d8-d3ef-11ed-0729-cda246d8870f
md"""
# Transformada Z
"""

# ╔═╡ 597b76a2-54b9-4f42-87af-085ad2de0121
begin
	num = [ 1, 0, 1, ]
	den = [ 1, -1.85, 0.9 ]
	Ts = 1
...
# ╔═╡ 4540c0fa-d31c-4422-a3ec-8baf42404151
H = tf(num,den,Ts)

# ╔═╡ 0f279631-a091-48b9-b16c-245196cbbd55
plot(impulse(H);
	title="Resposta ao Impulso"
)

# ╔═╡ b0082966-e24d-40af-b299-40357ef880db
plot(step(H);
	title="Resposta ao Degrau Unitário",
)

# ╔═╡ 2e5c2e83-f732-4afb-ab07-ada345da94b8
s = step(H)

# ╔═╡ 8abf0295-1d4f-4c3b-a632-c5be61fbd5ad
begin
	amplitude = 0.3
	y = amplitude.*s.y
	plot(s.t,y';
		title="Resposta ao Degrau de Amplitude $amplitude"
	)
end
